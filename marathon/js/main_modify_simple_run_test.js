...
game.StatesNew.preload = function() {
	...
	this.preload = function() {
		...
		game.load.spritesheet('buddy', '../../assets/images/buddy.png', _Con_sprite.buddy.width, _Con_sprite.buddy.height, _Con_sprite.buddy.frameNumber);
		game.load.spritesheet('button', '../../assets/images/button.png', _Con_sprite.button.width, _Con_sprite.button.height, _Con_sprite.button.frameNumber);
		//voice
		game.load.audio('player_sound', '../../assets/sound/play.mp3');
		game.load.audio('score_sound', '../../assets/sound/score.mp3');
		// font
...
game.StatesNew.play = function() {
	...
	this.create = function() {
		...
		// 背景
		// tileSprite-> Phaser. TileSprite
		this.bg = game.add.tileSprite(0, 0, _Con_sprite.background.width, /* _Con_sprite.background.height */450, 'background');
		this.ground = game.add.tileSprite(0, game.height -150/* _Con_sprite.ground.height */ , game.width, 150/* _Con_sprite.ground.height */ , 'ground');
		...
		var btnLeft = game.add.button(game.world.centerX-50, 50 , "button", this.runLeft, this, 2, 2, 0);
		...
		//player
    	this._buddyPos = game.height - _Con_sprite.buddy.height -(150/3);
  ...
  this.runLeft = function() {
	...
	this._buddy.animations.stop('move');//先停止动画
	gameSpeed +=10;//再增加动画播放速度
	that._buddy.animations.play('move', gameSpeed, true);
	// this._buddy.body.velocity.x = 10 + 1000;
...
//   };
	...
	this.onStart = function() {
		// this.score = 0;
		this._buddy.body.velocity.x = 150;
