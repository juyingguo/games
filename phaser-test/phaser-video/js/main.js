...
function preload() {
	...
	game.load.image("test_next_page", "assets/test_next_page.png");
...
function create() {
	...
	this.test_next_pag = game.add.button(game.width - 74, 0, 'test_next_page', function() {
        console.log("test_next_page click.");
		video.play();
	});
